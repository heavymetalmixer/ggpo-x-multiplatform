...
typedef struct {
   ...
   bool (*begin_game)(void* context, const char *game);
   ...
   bool (*save_game_state)(void* context, unsigned char **buffer, int *len, int *checksum, int frame);
   ...
   bool (*load_game_state)(void* context, unsigned char *buffer, int len, int framesToRollback);
   ...
   bool (*log_game_state)(void* context, char *filename, unsigned char *buffer, int len);
   ...
   void (*free_buffer)(void* context, void *buffer);
   ...
   bool (*advance_frame)(void* context, int flags);
   ...
   bool (*on_event)(void* context, GGPOEvent *info);
...
GGPO_API GGPOErrorCode ggpo_client_chat(GGPOSession *,
                                        const char* message);
...
GGPO_API GGPOErrorCode ggpo_advance_frame(GGPOSession *, uint16_t checksum);
...
GGPO_API GGPOErrorCode ggpo_get_current_frame(GGPOSession* ggpo, int& nFrame);
